...
async function nextMetadataImageLoader(content) {
    ...
    export default async function (props) {
      ...
      const imageUrl = fillMetadataSegment(${JSON.stringify(segment)}, params, ${JSON.stringify(pageSegment)})
  ...
  export default (props) => {
    ...
    const imageUrl = fillMetadataSegment(${JSON.stringify(segment)}, props.params, ${JSON.stringify(pageSegment)})
